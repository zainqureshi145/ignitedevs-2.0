...
const PortfolioCard = ({ highlight, title, image }) => {
  return (
    <motion.div className="flex flex-col justify-between pt-5 h-96 w-72 lg:h-[750px] lg:w-[500px] rounded-lg border dark:border-slate-700 bg-blue-50 dark:bg-slate-800 p-2 m-5">
      ...
      <div className="flex flex-col justify-center items-center">
        <img className="rounded-lg w-28 lg:h-[500px] lg:w-[250px]" draggable="false" src={image} alt={image} />
      </div>
